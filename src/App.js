  ...
  render(){
    return(
      <div className="drum-pad" id={this.props.id} onClick={this.handleClick}>
        <audio src={this.props.src} className="clip" id={this.props.letter} ref={ref=>this.audio = ref}></audio>
  ...
  return (
    <div className="App">
      <div id="drum-machine">
        ...
        <div>
        {data.map(d=>{
          return <Pad key={d.id} id={d.id} letter={d.letter} src={d.src} handleDisplay={this.handleDisplay}/> 
        })}
        </div>
      </div>
    </div>
